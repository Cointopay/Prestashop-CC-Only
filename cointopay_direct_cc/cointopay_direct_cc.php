...
class Cointopay_Direct_Cc extends PaymentModule
{
    ...
    public function __construct()
    {
        ...
        $this->displayName = 'Pay via Visa / Mastercard';
    ...
    public function hookDisplayAdminOrderLeft($params)
    {
        ...
        $paymentUrl = Context::getContext()->shop->getBaseURL(true) . 'module/'.$this->name.'/makepayment?id_order=' . $id_order;
        ...
        if (Tools::isSubmit('send'.$this->name.'Payment')) {
            ...
            Tools::redirectAdmin('index.php?controller=AdminOrders&id_order='.$id_order.'&vieworder&conf=10&token='.$_GET['token']);
        }
        ...
        return '<div class="panel" id="cointopaydirectccform">
                    ...
                    <input type="submit" name="send'.$this->name.'Payment" value="Send To Customer" />
                    </form>
                </div>';
    }
