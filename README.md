...
Please follow the PrestaShop CC Only Cointopay Plugin install instructions mentioned here: https://docs.google.com/document/d/1cmF7aicJYFa2DCQbs2X3Qt3S1bdgYFdc_KsBeyB9TKM/edit?usp=sharing
...
1. Download <https://github.com/Cointopay/Prestashop-CC-Only/archive/cointopay-cc-only-prestashop-v1.0.0.zip>
...
5. Find **Pay via Visa / Mastercard** and click **Configure** button to next to it, then click **Proceed with the installation**.
